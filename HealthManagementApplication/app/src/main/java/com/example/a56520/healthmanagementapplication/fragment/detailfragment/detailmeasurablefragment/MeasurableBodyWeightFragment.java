...
public class MeasurableBodyWeightFragment extends Fragment {
    ...
    private MeasurableData[] measurableDatas = {
            new MeasurableData("体重",2,testDate,testResult1),
            new MeasurableData("体重",60,3456789,01),
            new MeasurableData("体重",61,3456789,01),
            new MeasurableData("体重",62,3456789,01),
            new MeasurableData("体重",63,3456789,01),
            new MeasurableData("体重",64,3456789,01),
            new MeasurableData("体重",65,3456789,01),
            new MeasurableData("体重",66,3456789,01),
            new MeasurableData("体重",68,3456789,01)};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_measurable_body_weight,
                container,false);
        initMeasurableData();
        RecyclerView recyclerView = v.
                findViewById(R.id.measurable_body_weight_recyclerView);
