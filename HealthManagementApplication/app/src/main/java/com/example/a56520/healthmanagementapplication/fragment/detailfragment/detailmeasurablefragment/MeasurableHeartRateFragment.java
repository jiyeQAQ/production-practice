...
public class MeasurableHeartRateFragment extends Fragment {
    ...
    private MeasurableData[] measurableDatas = {
            new MeasurableData( "心率", 2, testDate, testResult1 ),
            new MeasurableData( "心率", 71, 2222222, 01 ),
            new MeasurableData( "心率", 72, 2111111, 01 ),
            new MeasurableData( "心率", 73, 3301620, 01 ),
            new MeasurableData( "心率", 74, 2291624, 01 ),
            new MeasurableData( "心率", 75, 2281262, 01 ),
            new MeasurableData( "心率", 76, 2101212, 01 ),
            new MeasurableData( "心率", 77, 2151313, 01 ),
            new MeasurableData( "心率", 78, 2221414, 01 ),
            new MeasurableData( "心率", 79, 2231515, 01 )};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_measurable_heart_rate,
                container,false);
        initMeasurableData();
        RecyclerView recyclerView = v.
                findViewById( R.id.measurable_heart_rate_recyclerView );
