...
public class MeasurableBloodOxygenFragment extends Fragment {
    ...
    private MeasurableData[] measurableDatas = {
            new MeasurableData("血氧",2,testDate,testResult1),
            new MeasurableData("血氧",71,9102147,01),
            new MeasurableData("血氧",72,9102247,01),
            new MeasurableData("血氧",73,9102347,01),
            new MeasurableData("血氧",74,9110047,01),
            new MeasurableData("血氧",75,9120247,01),
            new MeasurableData("血氧",76,9132147,01),
            new MeasurableData("血氧",77,9132247,01),
            new MeasurableData("血氧",78,9151547,01)};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_measurable_blood_oxygen,
                container,false);

        initMeasurableData();
        RecyclerView recyclerView = v.
                findViewById( R.id.measurable_blood_oxygen_recyclerView);
