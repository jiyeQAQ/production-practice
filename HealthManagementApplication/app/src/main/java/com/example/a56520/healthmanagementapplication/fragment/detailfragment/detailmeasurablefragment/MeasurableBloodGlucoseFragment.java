...
public class MeasurableBloodGlucoseFragment extends Fragment {
    private int testDate[]={1809010000,1809020000,1809030000,1809030030,1809100000,1809110000,1809110030,1809110500,
            1809110600,1809110700,1809110730,1809110745,1809110800,1809110810};
    ...
    private MeasurableData[] measurableDatas = {
            new MeasurableData("血糖",2,testDate,testResult1),
            new MeasurableData("血糖",160,7418523,01),
            new MeasurableData("血糖",161,7418523,01),
            new MeasurableData("血糖",162,7418523,01),
            new MeasurableData("血糖",163,7418523,01),
            new MeasurableData("血糖",164,7418523,01),
            new MeasurableData("血糖",165,7418523,01),
            new MeasurableData("血糖",166,7418523,01),
            new MeasurableData("血糖",167,7418523,01),
            new MeasurableData("血糖",168,7418523,01)};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_measurable_blood_glucose,
                container,false);

        initMeasurableData();
        RecyclerView recyclerView = v.
                findViewById( R.id.measurable_blood_glucose_recyclerView );
